...
This command as given will show the 10 addresses with the most FQDN associations. Instead of `+` you could use
`>` to get the addresses with more than 10 FQDN associations.

Here's a 'blog article about this feature: http://consulting.m3047.net/dubai-letters/hot-addresses.html
