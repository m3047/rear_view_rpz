...
def heuristic_func(resolution):
    ...
    This is the "thoughtful attenuating" heuristic.
    ...
    * effect of query count should be attenuated when there is no activity
    
    The formula is:
    
        <base heuristic> + <boost>
    ...
    and <boost> is:
        ...
        ln(<query count>) / ( 1 + ( sqrt(<query trend>^2 + <last seen delta>^2) / 172800) ^ 2)
    """
